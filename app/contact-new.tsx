    ...
    <>
      ...
      <style >{`
        ...
        .contact-hero-overlay {
          ...
          right: 0;
          bottom: 0;
          background: linear-gradient(135deg, rgba(255, 123, 180, 0.3) 0%, rgba(163, 216, 255, 0.3) 100%);
          display: flex;
          align-items: center;
          ...
          <div className="glass-panel">
            ...
            <div className="contact-info-layout">
              ...
              <div className="contact-map-section">
                ...
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15447.1234!2d120.8533!3d14.4167!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397c9b8c8c8c8c%3A0x1234567890abcdef!2zMTTCsDI1JzAwLjAiTiAxMjDCsDUxJzEyLjAiRQ!5e0!3m2!1sen!2sph!4v1634567890123!5m2!1sen!2sph"
                  allowFullScreen
                  loading="lazy"
                  referrerPolicy="no-referrer-when-downgrade"
                  title="Tiny Steps Office Location"
                ></iframe>
              </div>
          ...
          <div className="glass-panel">
            ...
            <form id="contactForm" className="contact-form">
              ...
              <div className="form-group">
                ...
                <input id="contactPhone" type="tel" className="form-input" placeholder="(555) 123-4567" />
              </div>
              <div className="form-group">
